...
namespace ImageResizer.Util {
    ...
    public class Utils {
        ...
        /// <returns></returns>
        public static FlipMode parseFlip(string sFlip) {
            return ParseUtils.ParsePrimitive<FlipMode>(sFlip, FlipMode.None);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string writeFlip(FlipMode flip) {
            if (flip == FlipMode.None) return "none";
            if (flip == FlipMode.X) return "x";
            if (flip == FlipMode.Y) return "y";
            if (flip == FlipMode.XY) return "xy";
