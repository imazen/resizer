...
namespace ImageResizer {
    ...
    public class ResizeSettings : QuerystringBase<ResizeSettings> {
        ...
        /// </summary>
        public AnchorLocation Anchor                   { get {
            return this.Get<AnchorLocation>("anchor", AnchorLocation.MiddleCenter);       } set {
            this.Set<AnchorLocation>("anchor",value);      }}
        ...
        public FlipMode Flip                      { get {
                return this.Get<FlipMode>("flip", FlipMode.None);
            }
            set {
        ...
        /// </summary>
        public FlipMode SourceFlip                    { get {
            return this.Get<FlipMode>("sFlip", this.Get<FlipMode>("sourceFlip", FlipMode.None));
            }
            set {
