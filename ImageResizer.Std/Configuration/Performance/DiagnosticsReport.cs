...
namespace ImageResizer.Configuration.Performance
{
    class DiagnosticsReport
    {
        ...
        internal string Generate()
        {
            ...
            sb.AppendLine($"Diagnostics for ImageResizer {distinctVersions.Delimited(", ")} {distinctCommits.Delimited(", ")} generated {now}");
            ...
            sb.AppendLine(
                $"Running  on {Environment.OSVersion} and CLR {Environment.Version}"); //{ServerSoftware() ?? "NOT ASP.NET"}
