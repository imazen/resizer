...
namespace fbs.ImageResizer.Plugins.ResizeFolderSyntax {
    public class ResizeFolderModule {
        ...
        public static void Install() {
            fbs.ImageResizer.InterceptModule.RewriteDefaults += new UrlRewritingHook(InterceptModule_RewriteDefaults);
        }

        static void InterceptModule_RewriteDefaults(InterceptModule sender, UrlEventArgs e) {
