...
namespace ImageResizer {
    public partial class ImageBuilder {
        ...
        public class Job {
            public Job(object source, object dest, ResizeSettings settings) {
                this.Source = source;
                this.Dest = dest;
                this.Settings = settings;
            }

            public Job(object source, object dest, ResizeSettings settings, bool disposeSource, bool addFileExtension) {
                this.Source = source;
                this.Dest = dest;
                this.Settings = settings;
