<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CropExample.aspx.cs" Inherits="ComplexWebApplication.CropExample" %>
    ...
    <div>
        ...
        <div class="image-cropper">
            <table>
                <tr>
                    <td>
                        <img src="red-leaf.jpg?width=400" class="image" />
                    </td>
                    <td>
