...
<body>
    ...
    <asp:TextBox ID="col2" Text="width=400;scale=both;r.autoeyes=true;cache=no;" runat="server"  Width="400"/><br />
    <asp:TextBox ID="col3" Text="width=400;scale=both;r.filter=2;" runat="server"  Width="400"/><br />
