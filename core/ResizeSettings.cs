...
namespace ImageResizer
{
    ...
    public class ResizeSettings : QuerystringBase<ResizeSettings>
    {
        ...
        ///     The desired image format, like 'jpg', 'gif', or 'png'. Leave null if you want to preserve the
        ///     original format.
        /// </param>
        ...
        /// <summary>
        ///     ["maxwidth"]: Sets the maximum desired width of the image.  (minus padding, borders, margins, effects, and
        ///     rotation).
        ...
        {
            get => get("quality", 90);
            set => set("quality", value);
        }


        /// <summary>
        ///     ["maxheight"]: Sets the maximum desired height of the image.  (minus padding, borders, margins, effects, and
        ///     rotation).
        ///     The image may be smaller than this value to maintain aspect ratio when both maxwidth and maxheight are specified.
        /// </summary>
        ...
        public FitMode Mode
        {
            get => Get<FitMode>("mode", FitMode.None);
        ...
        {
            get => Get<ContentAlignment>("anchor", ContentAlignment.MiddleCenter);
        ...
        {
            get => (RotateFlipType)Get<FlipMode>("flip", FlipMode.None);
            set => Set<FlipMode>("flip", (FlipMode)value);
        }
        ...
        {
            get => (RotateFlipType)Get<FlipMode>("sFlip", Get<FlipMode>("sourceFlip", FlipMode.None));
            set => Set<FlipMode>("sflip", (FlipMode)value);
        }

        /// <summary>
        ///     ["scale"] Whether to downscale, upscale, upscale the canvas, or both upscale or downscale the image as needed.
        ///     Defaults to
        ///     DownscaleOnly. See the DefaultSettings plugin to adjust the default.
        /// </summary>
        public ScaleMode Scale
        {
            get => Get<ScaleMode>("scale", ScaleMode.DownscaleOnly);
        ...
        {
            get => Get<StretchMode>("stretch", StretchMode.Proportionally);
            set => Set<StretchMode>("stretch", value);
        }
        ...
        {
            get => Get<ServerCacheMode>("cache", ServerCacheMode.Default);
            set => this["cache"] = value.ToString();
        }

        /// <summary>
        ///     ["process"]: Server processing suggestion for the result. Allows you to 'disable' processing of the image (so you
        ///     can use disk caching with non-image files). Allows you to 'force' processing of the image, for images without a
        ///     querystring.
        /// </summary>
        public ProcessWhen Process
        {
            get => Get<ProcessWhen>("process",
                this["useresizingpipeline"] != null ? ProcessWhen.Always : ProcessWhen.Default);
            set
            {
                this["process"] = value.ToString();
                Remove("useresizingpipeline");
            }
        }

        /// <summary>
        ///     ["crop"]=none|auto Defaults to None - letterboxing is used if both width and height are supplied, and stretch =
        ///     proportionally.
        ...
        public CropMode CropMode
        {
            get
            {
                if ("auto".Equals(this["crop"], StringComparison.OrdinalIgnoreCase)) return CropMode.Auto;
                if (this.GetList<double>("crop", 0, 4) != null) return CropMode.Custom;
                return CropMode.None;
            }
            set
            {
                if (value == CropMode.None) Remove("crop");
                else if (value == CropMode.Auto) this["crop"] = "auto";
            }
        }

        /// <summary>
        ///     4 values specify x1,y1,x2,y2 values for the crop rectangle.
        ///     Negative values are relative to the bottom right - on a 100x100 picture, (10,10,90,90) is equivalent to
        ///     (10,10,-10,-10). And (0,0,0,0) is equivalent to (0,0,100,100).
        /// </summary>
        protected double[] CropValues
        {
            get
            {
                ...
                var vals = this.GetList<double>("crop", 0, 4);
        ...
        /// <summary>
        ///     ["crop"]=([x1],[y1],x2,y2). Sets x1 and y21, the top-left corner of the crop rectangle. If 0 or greater, the
        ///     coordinate is relative to the top-left corner of the image.
        ///     If less than 0, the value is relative to the bottom-right corner. This allows for easy trimming:
        ///     crop=(10,10,-10,-10).
        ///     Set ["cropxunits"] and ["cropyunits"] to the width/height of the rectangle your coordinates are relative to, if
        ///     different from the original image size.
        /// </summary>
        ...
        /// <summary>
        ///     ["crop"]=(x1,y1,[x2],[y2]). Sets x2 and y2, the bottom-right corner of the crop rectangle. If 1 or greater, the
        ///     coordinate is relative to the top-left corner of the image.
        ///     If 0 or less, the value is relative to the bottom-right corner. This allows for easy trimming:
        ///     crop=(10,10,-10,-10).
        ///     Set ["cropxunits"] and ["cropyunits"] to the width/height of the rectangle your coordinates are relative to, if
        ///     different from the original image size.
        /// </summary>
        ...
        {
            get => ParseUtils.ParseColor(this["bgcolor"], Color.Transparent);
            set => this["bgcolor"] = ParseUtils.SerializeColor(value);
        }
        ...
        {
            get => ParseUtils.ParseColor(this["paddingColor"], Color.Transparent);
            set => this["paddingColor"] = ParseUtils.SerializeColor(value);
        }
        ...
        {
            get => BoxPadding.Parse(this["paddingWidth"], BoxPadding.Empty);
            set => SetAsString<BoxPadding>("paddingWidth", value);
        }
        ...
        {
            get => BoxPadding.Parse(this["margin"], BoxPadding.Empty);
            set => SetAsString<BoxPadding>("margin", value);
        }
        ...
        {
            get => ParseUtils.ParseColor(this["borderColor"], Color.Transparent);
            set => this["borderColor"] = ParseUtils.SerializeColor(value);
        }
        ...
        {
            get => BoxPadding.Parse(this["borderWidth"], BoxPadding.Empty);
            set => SetAsString<BoxPadding>("borderWidth", value);
        }

        /// <summary>
        ///     Like this["format"].
        ///     Gets or sets the output file format to use. 'png', 'jpg', and 'gif' are valid values.
        ///     Returns null if unspecified. When format is not specified, the original format of the image is used (unless it is
        ///     not a web safe format  - JPEG is the fallback in that scenario).
        ///     <remarks>
        ///         Also checks the 'thumbnail' value for V2 compatibility. When set, 'thumbnail' is removed and only 'format' is
        ///         used.
        ///     </remarks>
        /// </summary>
        ...
        /// <summary>
        ///     The width which the X and X2 crop values should be applied. For example, a value of '100' makes X and X2
        ///     percentages of the original image width.
        ///     This can be set to any non-negative value. Very useful for performing cropping when the original image size is
        ///     unknown.
        ///     0 indicates that the crop values are relative to the original size of the image.
        /// </summary>
        public double CropXUnits
        {
            get => Get<double>("cropxunits", 0);
            set => Set<double>("cropxunits", value <= 0 ? null : (double?)value);
        }

        /// <summary>
        ///     The width which the Y and Y2 crop values should be applied. For example, a value of '100' makes Y and Y2
        ///     percentages of the original image height.
        ///     This can be set to any non-negative  value. Very useful for performing cropping when the original image size is
        ///     unknown.
        ///     0 indicates that the crop values are relative to the original size of the image.
        /// </summary>
        ...
        {
            get => Get<double>("cropyunits", 0);
            set => Set<double>("cropyunits", value <= 0 ? null : (double?)value);
        }


        public RectangleF getCustomCropSourceRect(SizeF imageSize)
        {
            var xunits = Get<double>("cropxunits", 0);
            var yunits = Get<double>("cropyunits", 0);
        ...
        {
            if (string.IsNullOrEmpty(this["thumbnail"]) && string.IsNullOrEmpty(this["format"]))
                this["format"] = format;
        }

        /// <summary>
        ///     Returns a string containing all the settings in the class, in querystring form. Use ToStringEncoded() to get a
        ///     URL-safe querystring.
